...
Agent = "Mozilla/5.0 (Linux; Android 12; Mi 10 Build/SKQ1.220303.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) " \
        "Version/4.0 Chrome/99.0.4844.88 Mobile Safari/537.36 Yoda/2.8.3-rc1 ksNebula/10.4.10.3430 OS_PRO_BIT/64 " \
        "MAX_PHY_MEM/7611 AZPREFIX/zw ICFO/0 StatusHT/32 TitleHT/44 NetType/WIFI ISLP/0 ISDM/0 ISLB/0 locale/zh-cn " \
        "evaSupported/false CT/0 "

# 交流群 481276206
# 获取账号信息
def getInformation(cookie):
    url = "https://nebula.kuaishou.com/rest/n/nebula/activity/earn/overview/basicInfo"
    headers = {'User-Agent': Agent, 'Accept': '*/*', "Connection": "close", 'Accept-Language': 'zh-CN,zh;q=0.9', 'Cookie': cookie}
